package br.com.local.appempregadossqlite;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String NOME_BANCO_DE_DADOS = "Empregados";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lblVisualizaFuncionario:
                startActivity(new Intent(getApplicationContext(), FuncionariosActivity.class));
                break;
        }
